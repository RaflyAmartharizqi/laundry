...
Route::get('/detail', 'DetailtransaksiController@nampil')->middleware('jwt.verify');
Route::get('/tgl_transaksi/{id}', 'TransaksiController@berdasarkantanggal')->middleware('jwt.verify');
Route::post('/tanggal_transaksi', 'TransaksiController@tampilkan');
